...
export class Tables1756515482357 implements MigrationInterface {
    name = 'Tables1756515482357'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posta" ADD "lat" nvarchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "posta" DROP COLUMN "lng"`);
        await queryRunner.query(`ALTER TABLE "posta" ADD "lng" nvarchar(255) NOT NULL`);
